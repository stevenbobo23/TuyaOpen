...
static OPERATE_RET __get_ui_font(UI_FONT_T *ui_font)
{
    ...
    if (ui_font == NULL) {
     ...
     defined(BOARD_CHOICE_T5AI_MOJI_1_28) || defined(BOARD_CHOICE_T5AI_MINI) || defined(BOARD_CHOICE_TUYA_T5AI_MINI) || \
     defined(BOARD_CHOICE_TUYA_T5AI_CORE) || defined(BOARD_CHOICE_DNESP32S3_BOX) || defined(BOARD_CHOICE_DNESP32S3_BOX2_WIFI))
